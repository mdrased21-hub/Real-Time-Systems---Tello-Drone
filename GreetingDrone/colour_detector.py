...
def color(tello_drone):
    ...
    while True:
        # while hue_flag == False or saturation_flag == False or lightness_flag == False:
        ...
        img_bgr_lower, img_bgr_higher = cv2.cvtColor(img_hsv_lower, cv2.COLOR_HSV2BGR), cv2.cvtColor(img_hsv_higher,
                                                                                                     cv2.COLOR_HSV2BGR)
